...
const {pagination, getSuperPower, upload, validateBody} = require("../middlewares/import");


heroRouter.post("/", upload.single("image"), getSuperPower, validateBody, HeroController.createOne);
